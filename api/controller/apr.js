...
exports.apr_get_all = (req, res, next) => {
    Apr.find()
    .exec()
    .then(docs => {
        if(docs.length >=1) {
...
exports.apr_get_one = (req, res, next) => {
...
exports.apr_update = (req, res, next) => {
    const id = req.params.userID;
    const updateOps = {};
...
exports.apr_delete = (req, res, next) => {
    const id = req.params.userID;
    Apr.remove({ _id: id })
    .exec()
    .then(result => {
