...
exports.dec_get_all = (req, res, next) => {
    Dec.find()
    .exec()
    .then(docs => {
        if(docs.length >=1) {
...
exports.dec_get_one = (req, res, next) => {
...
exports.dec_update = (req, res, next) => {
    const id = req.params.userID;
    const updateOps = {};
...
exports.dec_delete = (req, res, next) => {
    const id = req.params.userID;
    Dec.remove({ _id: id })
    .exec()
    .then(result => {
